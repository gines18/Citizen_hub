...
const params = useParams();
  ...
  return (
    <>
      ...
      <main className=" max-w-{size} format format-{color} pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased mt-10 flex justify-center ml-auto mr-auto">
